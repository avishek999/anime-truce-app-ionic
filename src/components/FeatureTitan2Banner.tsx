...
const FeatureTitan2Banner = () => {
  return (
    <div className="mt-20 ">
      <div className=" banner_background_image backdrop-blur-sm    mx-auto bg-white/20 border border-neutral-500 h-[100px] border-dotted  w-96 rounded-xl  shadow-lg shadow-white/20  ">
