...
export const getTopAiringAnimeData = async (): Promise<
  IApiResponse<ITopAiringAnime>
> => {
  try {
...
export const getRecentAnimeData = async (): Promise<
  IApiResponse<ITopAiringAnime>
> => {
  try {
...
export const getPopularAnimeData = async (): Promise<
  IApiResponse<ITopAiringAnime>
> => {
  try {
    const response = await axios.get(`${ANIME_URL}/popular`);
    return response.data;
  } catch (error) {
    console.log(error, ERROR_MESSAGES.UNEXPECTED_ERROR);
    throw new Error(ERROR_MESSAGES.UNEXPECTED_ERROR);
...
export const getRandomAnimeData = async (): Promise<
  IApiResponse<ITopAiringAnime>
> => {
  try {
    const response = await axios.get(`${ANIME_URL}/latest`);
    return response.data;
  } catch (error) {
    console.log(error, ERROR_MESSAGES.UNEXPECTED_ERROR);
    throw new Error(ERROR_MESSAGES.UNEXPECTED_ERROR);
...
export const getAnimeDetails = async (
  id: string
): Promise<IApiResponse<IAnimeDetails>> => {
  try {
...
export const getAnimeWatchDetails = async (
  id: string
): Promise<IApiResponse<IAnimeDetails>> => {
  try {
